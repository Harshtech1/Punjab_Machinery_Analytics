// ==============================================================================
// Punjab Government Decision Support Dashboard - V4
...
var mergedVillages = fc_villages.map(function(f) {
  // Calculate Base Machinery & Schemes
  var in_situ = ee.Number(f.get('In_Situ')).defaultIfNull(0);
  var ex_situ = ee.Number(f.get('Ex_Situ')).defaultIfNull(0);
  var prime = ee.Number(f.get('Prime_Mover')).defaultIfNull(0);
  var gen = ee.Number(f.get('General')).defaultIfNull(0);
