// ==============================================================================
// Punjab Government Decision Support Dashboard - V9 (Executive)
...
var districtSelect = ui.Select({
  ...
  onChange: function(dist) {
    ...
    // Short string layer description: 'District Highlight'
...
var rightPanel = ui.Panel({
  style: {width: '280px', position: 'top-right', padding: '15px', backgroundColor: 'rgba(255, 255, 255, 0.95)', border: '1px solid #cccccc'}
});

var activeThematic = 'Intervention_Priority';
var showPunjab = true;
...
function onThematicCheck(key, checked, cbWidget) {
  if (checked) {
    ...
    // If unchecked, leave activeThematic as null
...
var inspectorPanel = ui.Panel({
  style: {width: '320px', padding: '15px', position: 'bottom-right', shown: false, backgroundColor: '#ffffff', border: '2px solid #2b6cb0', boxShadow: '0 4px 6px rgba(0,0,0,0.3)'}
});
...
Map.onClick(function(coords) {
  ...
  clickedFeature.evaluate(function(feature) {
    ...
    var ch4Val = props['Pred_CH4'] ? props['Pred_CH4'].toFixed(1) + ' ppb' : 'N/A';
    ...
    inspectorPanel.add(ui.Panel({
      widgets: [
        ui.Label(ch4Val, {fontSize: '14px', color: '#1a202c', fontWeight: 'bold', stretch: 'horizontal'}),
